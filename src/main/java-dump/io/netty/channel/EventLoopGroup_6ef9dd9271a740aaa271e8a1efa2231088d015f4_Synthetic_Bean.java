...
import io.quarkus.netty.BossEventLoopGroup_Shared_AnnotationLiteral;
...
// $FF: synthetic class
public class EventLoopGroup_6ef9dd9271a740aaa271e8a1efa2231088d015f4_Synthetic_Bean implements InjectableBean, Supplier {
    private final Set types;
    private final Set qualifiers;
    private final Map params;

    public EventLoopGroup_6ef9dd9271a740aaa271e8a1efa2231088d015f4_Synthetic_Bean() {
        ...
        BossEventLoopGroup_Shared_AnnotationLiteral var6 = new BossEventLoopGroup_Shared_AnnotationLiteral();
        ((Set)var5).add(var6);
    ...
    public String getIdentifier() {
        return "6ef9dd9271a740aaa271e8a1efa2231088d015f4";
    }
    ...
    public EventLoopGroup create(CreationalContext var1) {
        Object var2 = ArcRecorder.supplierMap.get("io_netty_channel_EventLoopGroup_6dfeb892fe74673f0da1d912091f4301b010770d");
        if (var2 != null) {
            return (EventLoopGroup)((Supplier)var2).get();
        } else {
            throw (Throwable)(new CreationException("Synthetic bean instance for io.netty.channel.EventLoopGroup not initialized yet: io_netty_channel_EventLoopGroup_6dfeb892fe74673f0da1d912091f4301b010770d\n\t- a synthetic bean initialized during RUNTIME_INIT must not be accessed during STATIC_INIT\n\t- RUNTIME_INIT build steps that require access to synthetic beans initialized during RUNTIME_INIT should consume the SyntheticBeansRuntimeInitBuildItem"));
        }
    }
        ...
        if (!Objects.referenceEquals(this, var1)) {
            if (var1 != null) {
                if (var1 instanceof InjectableBean) {
                    ...
                    return "6ef9dd9271a740aaa271e8a1efa2231088d015f4".equals(var2);
                } else {
                    return (boolean)0;
                }
            } else {
    ...
    public int hashCode() {
        return "6ef9dd9271a740aaa271e8a1efa2231088d015f4".hashCode();
    }
}
